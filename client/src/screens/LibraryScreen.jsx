      ...
      <div className="bg-gray-800 px-4 py-2 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          <button
            ...
            className="flex items-center gap-1 h-8 px-3 bg-blue-600 hover:bg-blue-500 text-white rounded-lg text-sm disabled:opacity-40 transition-colors"
          >
            View
          </button>
          <button
            ...
            className="flex items-center gap-1 h-8 px-3 bg-red-600 hover:bg-red-500 text-white rounded-lg text-sm disabled:opacity-40 transition-colors"
          >
