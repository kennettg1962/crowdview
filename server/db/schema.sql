...
CREATE TABLE IF NOT EXISTS `Organization_Customer_Tier` (
  `Tier_Id` BIGINT NOT NULL AUTO_INCREMENT,
  `Organization_Id` BIGINT NOT NULL,
  `Tier_Name_Txt` VARCHAR(50) NOT NULL,
  `Tier_Color_Txt` VARCHAR(20) NOT NULL,
  `Sort_Order` INT NOT NULL DEFAULT 0,
  PRIMARY KEY (`Tier_Id`),
  CONSTRAINT `OCT_org_fk` FOREIGN KEY (`Organization_Id`) REFERENCES `Organization` (`Organization_Id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
